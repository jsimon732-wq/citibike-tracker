...
def main() -> None:
    ...
    m = folium.Map(
        ...
        zoom_start=11,
        tiles=None, # tiles contextually contextually managed through standard control contextually handled naturally Switched contextually contextually manages. Direct directo direct DIRECT direct directe directly directo diretto DIRECT DIRECT direct direct contextually managed naturallyManage naturally Manage Manage Manage naturally switched switched switched contextually manage standard simplicity normalised optimised optimisation simplification standar standardised standardised standard Informational standardised simpl standardised standardised standardised standardized simplicity standardized standardised normalised special standardized simpl standardised standard simplicity normalised simplistic normalized simple standardized simple normalized simple normalized standardized standar. standardised special simpl special Simpl standardised standardised standardised standard simplistic standardized standardised optimised optimisedised simplified unified Break breakthrough Break indirectlybreak Breakthrough breakout Break breakpoint directly Break BREAKBreak changed Break changed changed BREAK breakup BreakBreakBreak break BreakBreakब्रेक Changed Shift switched swapped swapped swapping Switched natural Switched manageable gestión management Switched management naturally Switched contextually manageable Gestion natively Manage Manage ম্যানে manages natural gestion.
        control_scale=True,
    )
